...
public enum Axe {
  ...
  /** Mithril axe, requires level 21 woodcutting and level 20 attack. */
  MITHRIL("Mithril axe", 21, 20, false),
  /** Adamant axe, requires level 31 woodcutting and level 30 attack. */
  ADAMANT("Adamant axe", 31, 30, false),
