...
This repo contains a collection of botting scripts for the [DreamBot][1] Old School Runescape
client. Why Merlin? That's my DreamBot username and the user under which these
scripts may one day officially be published on the Script Developer Network.
...
- The Maven build tool. You can install this using your system's package manager
  or by downloading it from the [Maven
  website][4].
...
In the near future, there will be pre-built releases of each script's JAR
file for download here on GitHub. For now, you can build the project following
